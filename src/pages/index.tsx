...
import { Suspense, useEffect, useState, useContext, Fragment } from "react";
import { UIEarthContext } from "@/context/ui-earth-context";
import { useHover } from "@mantine/hooks";
import { Anchor, Button, MantineGradient, SimpleGrid, Text, Card, Image as MantineImage, Badge, Group } from "@mantine/core";
import {
  IconBrandGithub,
  IconBrandGmail,
  IconBrandLinkedin,
...
const Index = () => {
  ...
  return (
    <Main meta={<Meta title="Home" description="Eoin's website" />}>
      ...
      <div>
        Currently practicing Typescript, Python, and Golang
      </div>
